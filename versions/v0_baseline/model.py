"""V0 Baseline E2CO model — identical architecture to the original PINNE2CO."""
...
class BaselineE2CO(nn.Module):
    """V0 Baseline E2CO — identical architecture to PINNE2CO, no physics losses."""
