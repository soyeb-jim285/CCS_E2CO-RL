"""V1 Physics-Constrained E2CO training script — data + physics losses."""
...
from versions.v1_physics_constrained.model import PhysicsConstrainedE2CO
from versions.v1_physics_constrained.loss import PhysicsLoss

# Parse CLI args
cfg = BaseConfig.from_args()
cfg.version_name = "v1_physics_constrained"

print(f"=== V1 Physics-Constrained E2CO ===")
