"""V4 Neural ODE loss — 8 terms with adaptive weights (same as V1 physics loss)."""
...
class NeuralODELoss(nn.Module):
    """Combined data-driven + physics-informed loss for V4 Neural ODE E2CO.
    ...
    def __init__(self, cfg, perm_log, device):
        ...
        # Precompute harmonic transmissibility
