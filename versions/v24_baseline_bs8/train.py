"""V24 Baseline BS8 — V0 architecture trained from scratch with batch_size=8."""
...
from versions.v24_baseline_bs8.model import BaselineE2CO
from versions.v24_baseline_bs8.loss import BaselineLoss

cfg = BaseConfig.from_args()
cfg.version_name = "v24_baseline_bs8"
cfg.batch_size = 8

print(f"=== V24 Baseline (batch_size={cfg.batch_size}) ===")
