"""V16 Observation-Weighted Physics E2CO training script."""
...
from versions.v16_obs_weighted_physics.model import CoordinatePINNE2CO
from versions.v16_obs_weighted_physics.loss import ObsWeightedPhysicsLoss
...
def add_extra_args(parser):
    ...
    parser.add_argument("--well_influence_radius", type=int, default=5)
...
cfg.version_name = "v16_obs_weighted_physics"
cfg.use_compile = False

print(f"=== V16 Observation-Weighted Physics E2CO ===")
...
print(f"Collocation points: {cfg.n_collocation_points}, "
      f"well_influence_radius: {cfg.well_influence_radius}")
...
loss_fn = ObsWeightedPhysicsLoss(
    cfg, perm, device,
    lambda_consistency=cfg.lambda_consistency,
    well_influence_radius=cfg.well_influence_radius,
).to(device)
