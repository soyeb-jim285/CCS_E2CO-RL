"""V3: Physics loss — same 8-term physics-constrained loss as V1.
...
class PhysicsLoss(nn.Module):
    """Combined data-driven + physics-informed loss for V3 Physics Corrector E2CO.

    8 loss terms identical to V1.
    """
