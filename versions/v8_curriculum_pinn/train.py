"""V8 Curriculum PINN E2CO training script."""
...
from versions.v8_curriculum_pinn.model import CoordinatePINNE2CO
from versions.v8_curriculum_pinn.loss import CurriculumPINNLoss
...
cfg.version_name = "v8_curriculum_pinn"
cfg.use_compile = False

print(f"=== V8 Curriculum PINN E2CO ===")
