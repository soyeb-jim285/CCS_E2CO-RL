"""V9 Pressure-Only PINN E2CO training script."""
...
from versions.v9_pressure_only_pinn.model import CoordinatePINNE2CO
from versions.v9_pressure_only_pinn.loss import PressureOnlyPINNLoss
...
cfg.version_name = "v9_pressure_only_pinn"
cfg.use_compile = False

print(f"=== V9 Pressure-Only PINN E2CO ===")
