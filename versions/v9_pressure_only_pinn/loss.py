"""V9 Pressure-Only PINN loss — only pressure PDE autograd, no mass/darcy."""
...
class PressureOnlyPINNLoss(nn.Module):
    """Pressure-only autograd physics + consistency loss.
    ...
    def _autograd_pressure_only(self, pinn_out, coords):
        """Only compute pressure PDE residual — skip saturation derivatives."""
