"""V23 Baseline BS4 — V0 architecture trained from scratch with batch_size=4."""
...
from versions.v23_baseline_bs4.model import BaselineE2CO
from versions.v23_baseline_bs4.loss import BaselineLoss

cfg = BaseConfig.from_args()
cfg.version_name = "v23_baseline_bs4"
cfg.batch_size = 4

print(f"=== V23 Baseline (batch_size={cfg.batch_size}) ===")
